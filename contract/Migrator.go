...
// MigratorABI is the input ABI used to generate the binding from.
// Deprecated: Use MigratorMetaData.ABI instead.
...
// MigratorSession is an auto generated Go binding around an Ethereum contract,
...
// MigratorCallerSession is an auto generated read-only Go binding around an Ethereum contract,
...
// MigratorTransactorSession is an auto generated write-only Go binding around an Ethereum contract,
...
func NewMigrator(address common.Address, backend bind.ContractBackend) (*Migrator, error) {
	contract, err := bindMigrator(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &Migrator{MigratorCaller: MigratorCaller{contract: contract}, MigratorTransactor: MigratorTransactor{contract: contract}, MigratorFilterer: MigratorFilterer{contract: contract}}, nil
}
...
func NewMigratorCaller(address common.Address, caller bind.ContractCaller) (*MigratorCaller, error) {
	contract, err := bindMigrator(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &MigratorCaller{contract: contract}, nil
}
...
func NewMigratorTransactor(address common.Address, transactor bind.ContractTransactor) (*MigratorTransactor, error) {
	contract, err := bindMigrator(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &MigratorTransactor{contract: contract}, nil
}
...
func NewMigratorFilterer(address common.Address, filterer bind.ContractFilterer) (*MigratorFilterer, error) {
	contract, err := bindMigrator(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &MigratorFilterer{contract: contract}, nil
}

// bindMigrator binds a generic wrapper to an already deployed contract.
func bindMigrator(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(MigratorABI))
	if err != nil {
		return nil, err
	}
...
func (_Migrator *MigratorRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _Migrator.Contract.MigratorCaller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_Migrator *MigratorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Migrator.Contract.MigratorTransactor.contract.Transfer(opts)
}
...
func (_Migrator *MigratorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _Migrator.Contract.MigratorTransactor.contract.Transact(opts, method, params...)
}
...
func (_Migrator *MigratorCallerRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _Migrator.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_Migrator *MigratorTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Migrator.Contract.contract.Transfer(opts)
}
...
func (_Migrator *MigratorTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _Migrator.Contract.contract.Transact(opts, method, params...)
}
...
func (_Migrator *MigratorCaller) NewRouter(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Migrator.contract.Call(opts, &out, "newRouter")
...
func (_Migrator *MigratorSession) NewRouter() (common.Address, error) {
	return _Migrator.Contract.NewRouter(&_Migrator.CallOpts)
}
...
func (_Migrator *MigratorTransactor) Migrate(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Migrator.contract.Transact(opts, "migrate")
}
...
func (_Migrator *MigratorSession) Migrate() (*types.Transaction, error) {
	return _Migrator.Contract.Migrate(&_Migrator.TransactOpts)
}
